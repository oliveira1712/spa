...
function Plan({ name, price, description, href, features, featured = false }: Plan) {
	return (
		<section
		...
		>
			...
			<ButtonLink
				...
				color={featured ? 'solidWhite' : 'outlineWhite'}
				className="mt-8"
...
export default function Pricing() {
	return (
		<section
			...
			className="min-h-[80vh] bg-slate-900 py-20 sm:py-32"
		>
			...
			<Container>
				<div className="md:text-center">
					<p className="font-display text-3xl tracking-tight text-white sm:text-4xl">
						<span className="relative whitespace-nowrap">
							...
							<span className="relative"> Preços acessíveis,</span>
						</span>{' '}
						para todos.
					</p>
					<p className="mt-4 text-lg text-slate-400">
						Não importa o tamanho do seu negócio, o nosso software está pronto para atender às suas
						necessidades.
					</p>
				</div>
				<div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
					<Plan
						...
						price="€9"
						description="Perfeito para quem está a começar."
						href="/register"
						features={[
							'Licença e Software',
							'Manual de suporte',
							'Armazenamento Digital: 1GB',
							'Conexão até 2 contas bancárias',
						]}
					/>
					<Plan
						featured
						...
						features={[
							'Licença e Software',
							'Manual de Suporte',
							'Armazenamento Digital: 3GB',
							'Prestação de serviços durante 1/2 ano',
							'Conexão até 5 contas bancárias',
						]}
					/>
					<Plan
						...
						features={[
							'Licença e Software',
							'Manual de Suporte',
							'Armazenamento Digital: 5GB',
							'Prestação de serviços durante 1 ano',
							'Conexão até 12 contas bancárias',
						]}
					/>
				</div>
			</Container>
